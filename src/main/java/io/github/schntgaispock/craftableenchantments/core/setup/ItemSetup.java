...
public class ItemSetup {
    ...
    public static void setup() {
        ...
        final ItemStack EXPERIENCE_BOTTLE = new ItemStack(Material.EXPERIENCE_BOTTLE);
        ...
        final ItemStack STONE_SLAB = new ItemStack(Material.STONE_SLAB);
        ...
        new SlimefunItem(
            ...
            new SlimefunItemStack(CEStacks.TOME_OF_AIR, 2)).register(ce);

        new SlimefunItem(
            CEGroups.TOMES,
            CEStacks.TOME_OF_EARTH,
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
            ...
            new SlimefunItemStack(CEStacks.TOME_OF_EARTH, 2)).register(ce);

        new SlimefunItem(
            CEGroups.TOMES,
            CEStacks.TOME_OF_FIRE,
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
            ...
            new SlimefunItemStack(CEStacks.TOME_OF_FIRE, 2)).register(ce);

        new SlimefunItem(
            CEGroups.TOMES,
            CEStacks.TOME_OF_WATER,
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
            ...
            new SlimefunItemStack(CEStacks.TOME_OF_WATER, 2)).register(ce);

        new SlimefunItem(
            CEGroups.TOMES,
            CEStacks.TOME_OF_LIGHTNING,
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
            ...
            new SlimefunItemStack(CEStacks.TOME_OF_RESILIENCE, 2)).register(ce);

        new SlimefunItem(
            CEGroups.TOMES,
            CEStacks.TOME_OF_SOUL,
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SOUL_SOIL, SlimefunItems.SOULBOUND_RUNE, SOUL_SAND,
                SlimefunItems.MAGIC_LUMP_1, BOOK, SlimefunItems.MAGIC_LUMP_1,
                SOUL_SAND, SlimefunItems.LIGHTNING_RUNE, SOUL_SOIL
            },
            new SlimefunItemStack(CEStacks.TOME_OF_SOUL, 2)).register(ce);

        new SlimefunItem(
            CEGroups.TOMES,
            CEStacks.TOME_OF_SWIFTNESS,
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
            ...
            new SlimefunItemStack(CEStacks.TOME_OF_SWIFTNESS, 2)).register(ce);

        new SlimefunItem(
            CEGroups.TOMES,
            CEStacks.TOME_OF_FORCE,
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
            ...
            new SlimefunItemStack(CEStacks.TOME_OF_FORCE, 2)).register(ce);

        new SlimefunItem(
            CEGroups.TOMES,
            CEStacks.TOME_OF_RESILIENCE,
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
        ...
        new SlimefunItem(
            ...
            new SlimefunItemStack(CEStacks.TOME_OF_FINESSE, 2)).register(ce);

        new SlimefunItem(
            CEGroups.TOMES,
            CEStacks.TOME_OF_SERENDIPITY,
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
            ...
            new SlimefunItemStack(CEStacks.TOME_OF_SERENDIPITY, 2)).register(ce);

        new SlimefunItem(
            CEGroups.TOMES,
            CEStacks.TOME_OF_SEEKING,
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
            ...
            new SlimefunItemStack(CEStacks.TOME_OF_SEEKING, 2)).register(ce);

        new SlimefunItem(
            CEGroups.TOMES,
            CEStacks.TOME_OF_EXORCISM,
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
            ...
            new SlimefunItemStack(CEStacks.TOME_OF_EXORCISM, 2)).register(ce);

        new SlimefunItem(
            CEGroups.TOMES,
            CEStacks.TOME_OF_REVERSAL,
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
            ...
            new SlimefunItemStack(CEStacks.TOME_OF_REVERSAL, 2)).register(ce);

        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.WATER_WORKER),
            "CE_AQUA_AFFINITY",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_FINESSE, SlimefunItems.MAGIC_LUMP_1,
                SPONGE, CEStacks.ENCHANTED_BOOK_BINDING, SPONGE,
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_WATER, SlimefunItems.MAGIC_LUMP_1
            }).register(ce);

        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.DAMAGE_ARTHROPODS),
            "CE_BANE_OF_ARTHROPODS",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_EXORCISM, SlimefunItems.MAGIC_LUMP_1,
                SPIDER_EYE, CEStacks.ENCHANTED_BOOK_BINDING, STRING,
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_AIR, SlimefunItems.MAGIC_LUMP_1
            }).register(ce);

        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.PROTECTION_EXPLOSIONS),
            "CE_BLAST_PROTECTION",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_RESILIENCE, SlimefunItems.MAGIC_LUMP_1,
                GUNPOWDER, CEStacks.ENCHANTED_BOOK_BINDING, GUNPOWDER,
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_EARTH, SlimefunItems.MAGIC_LUMP_1
            }).register(ce);

        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.CHANNELING),
            "CE_CHANNELING",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_LIGHTNING, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.DEPTH_STRIDER),
            "CE_DEPTH_STRIDER",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SWIFTNESS, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.DIG_SPEED),
            "CE_EFFICIENCY",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_FINESSE, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.PROTECTION_FALL),
            "CE_FEATHER_FALLING",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_REVERSAL, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.FIRE_ASPECT),
            "CE_FIRE_ASPECT",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_FORCE, SlimefunItems.MAGIC_LUMP_1,
                BLAZE_POWDER, CEStacks.ENCHANTED_BOOK_BINDING, BLAZE_POWDER,
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_FIRE, SlimefunItems.MAGIC_LUMP_1
            }).register(ce);

        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.PROTECTION_FIRE),
            "CE_FIRE_PROTECTION",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_RESILIENCE, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.ARROW_FIRE),
            "CE_FLAME",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_AIR, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.LOOT_BONUS_BLOCKS),
            "CE_FORTUNE",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SERENDIPITY, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.FROST_WALKER),
            "CE_FROST_WALKER",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_REVERSAL, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.IMPALING),
            "CE_IMPALING",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_EXORCISM, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.ARROW_INFINITE),
            "CE_INFINITY",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SERENDIPITY, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.KNOCKBACK),
            "CE_KNOCKBACK",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_FORCE, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.LOOT_BONUS_MOBS),
            "CE_LOOTING",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SERENDIPITY, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.LOYALTY),
            "CE_LOYALTY",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SEEKING, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.LUCK),
            "CE_LUCK_OF_THE_SEA",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SERENDIPITY, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.LURE),
            "CE_LURE",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SEEKING, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.MENDING),
            "CE_MENDING",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SERENDIPITY, SlimefunItems.MAGIC_LUMP_1,
                EXPERIENCE_BOTTLE, CEStacks.ENCHANTED_BOOK_BINDING, NETHER_STAR,
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_RESILIENCE, SlimefunItems.MAGIC_LUMP_1
            }).register(ce);

        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.MULTISHOT),
            "CE_MULTISHOT",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_FINESSE, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.PIERCING),
            "CE_PIERCING",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SEEKING, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.ARROW_DAMAGE),
            "CE_POWER",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_FORCE, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.PROTECTION_PROJECTILE),
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.PROTECTION_ENVIRONMENTAL),
            "CE_PROTECTION",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_RESILIENCE, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.ARROW_KNOCKBACK),
            "CE_PUNCH",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_FORCE, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.QUICK_CHARGE),
            "CE_QUICK_CHARGE",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_FINESSE, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.OXYGEN), // wtf bukkit
            "CE_RESPIRATION",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_WATER, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.RIPTIDE),
            "CE_RIPTIDE",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SWIFTNESS, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.DAMAGE_ALL),
            "CE_SHARPNESS",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SWIFTNESS, SlimefunItems.MAGIC_LUMP_1,
                STICK, CEStacks.ENCHANTED_BOOK_BINDING, STONE_SLAB,
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_WATER, SlimefunItems.MAGIC_LUMP_1
            }).register(ce);

        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.SILK_TOUCH),
            "CE_SILK_TOUCH",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SERENDIPITY, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.DAMAGE_UNDEAD),
            "CE_SMITE",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_EXORCISM, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.SOUL_SPEED),
            "CE_SOUL_SPEED",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SWIFTNESS, SlimefunItems.MAGIC_LUMP_1,
                SUGAR, CEStacks.ENCHANTED_BOOK_BINDING, SOUL_SAND,
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SOUL, SlimefunItems.MAGIC_LUMP_1
            }).register(ce);

        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.SWEEPING_EDGE),
            "CE_SWEEPING_EDGE",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SWIFTNESS, SlimefunItems.MAGIC_LUMP_1,
        ...
        if (Slimefun.getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_19))
            new VanillaItem(
                CEGroups.ENCHANTED_BOOKS,
                ItemSetup.getEnchantedBook(Enchantment.SWIFT_SNEAK),
                "CE_SWIFT_SNEAK",
                RecipeType.ANCIENT_ALTAR,
                new ItemStack[] {
                    SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_SWIFTNESS, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.THORNS),
            "CE_THORNS",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_RESILIENCE, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.BINDING_CURSE),
            "CE_CURSE_OF_BINDING",
            RecipeType.ANCIENT_ALTAR,
            new ItemStack[] {
                SlimefunItems.MAGIC_LUMP_1, CEStacks.TOME_OF_REVERSAL, SlimefunItems.MAGIC_LUMP_1,
        ...
        new VanillaItem(
            CEGroups.ENCHANTED_BOOKS,
            ItemSetup.getEnchantedBook(Enchantment.VANISHING_CURSE),
